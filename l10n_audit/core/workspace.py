...
def default_workspace_config(project_root: Path, profile_name: str) -> dict[str, Any]:
    return {
        ...
        "ai_review": {
            ...
            "batch_size": 20,
            "//_comment_request_timeout": "Provider timeout per request in seconds / مهلة الطلب لمزود الذكاء الاصطناعي بالثواني",
            "request_timeout_seconds": 60,
            "//_comment_max_failures": "Stop AI review after repeated provider failures / إيقاف مراجعة الذكاء بعد فشل مزود متكرر",
